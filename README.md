...
- **Authentication**: Local admin session
...
- `SUPABASE_SERVICE_ROLE_KEY` - Server-only Supabase service role key for uploads
- `SUPABASE_STORAGE_BUCKET` - Storage bucket name, defaults to `project-images`
- `JWT_SECRET` - Session signing secret
- `ADMIN_USERNAME` / `ADMIN_PASSWORD` - Production admin login
